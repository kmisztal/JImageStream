...
import pl.edu.uj.JImageStream.filters.statistical.DrawHistogram;
...
public class DrawHistogramTest extends AbstractBaseTest {
    @Test
    public void histogramFilterTest() {
        ...
        BufferedImage bufferedImage = streamableImage.stream()
                .apply(new DrawHistogram(lenaImage, ColorChannel.RED, ColorChannel.GREEN, ColorChannel.BLUE))

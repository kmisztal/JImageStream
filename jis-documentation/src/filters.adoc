...
.code
----
include::{sourcedir}/filters/LuminanceChanelFilter.java[tags=LuminanceChanelFilter]
----
...
.code
----
include::{sourcedir}/filters/BlueChrominanceChanelFilter.java[tags=BlueChrominanceChanelFilter]
----
...
.code
----
include::{sourcedir}/filters/RedChrominanceChanelFilter.java[tags=RedChrominanceChanelFilter]
----
...
.code
----
include::{sourcedir}/filters/RotateFilter.java[tags=RotateFilter]
----

...
.code
----
include::{sourcedir}/filters/LuminanceChanelFilterTest.java[tags=luminanceChanelFilter]
----
...
.code
----
include::{sourcedir}/filters/RedChrominanceChanelFilterTest.java[tags=redChrominanceChanelFilter]
----
...
.code
----
include::{sourcedir}\ResizeTest.java[tags=resize]
----
image::Resize.png[title="Resize", width="300", height="300"]
--

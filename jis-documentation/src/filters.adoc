...
.code
----
include::{sourcedir}/filters/OtsuBinarizationTest.java[tags=otsuFilter]
----
image::OtsuFilter.png[title="Otsu binarization", width="300", height="300"]

==== YCbCr filters

===== Luminance Chanel Filter

[source,java]
.code
----
include::{sourcedir}/filters/LuminanceChanelFilterTest.java[tags=LuminanceChanelFilterTest]
----
image::LuminanceChanelFilter.png[title="Luminance Chanel Filter", width="300", height="300"]

===== Blue Chrominance Chanel Filter

[source,java]
.code
----
include::{sourcedir}/filters/BlueChrominanceChanelFilterTest.java[tags=BlueChrominanceChanelFilter]
----
image::BlueChrominanceChanelFilter.png[title="Blue Chrominance Chanel Filter", width="300", height="300"]

===== Red Chrominance Chanel Filter

[source,java]
.code
----
include::{sourcedir}/filters/RedChrominanceChanelFilterTest.java[tags=RedChrominanceChanelFilterTest]
----
image::RedChrominanceChanelFilter.png[title="Red Chrominance Chanel Filter", width="300", height="300"]
...
.code
----
include::{sourcedir}/filters/Sobel4XFilterTest.java[tags=sobel45Filter]
----
image::Sobel45.png[title="Sobel45 Filter", width="300", height="300"]
...
.code
----
include::{sourcedir}/filters/Sobel4XFilterTest.java[tags=sobel135Filter]
----
image::Sobel135.png[title="Sobel135 Filter", width="300", height="300"]



===== Edge detection filter using four angles

[source,java]
.code
----
include::{sourcedir}/filters/Sobel4XFilterTest.java[tags=edgeDetectionSobel4XFilter]
----
--
image::Sobel4X.png[title="Sobel4X Filter", width="300", height="300"]
--
...
.code
----
include::{sourcedir}/filters/RotateFilterTest.java[tags=RotateFilter]
----
image::RotateFilter.png[title="Rotate Filter", width="300", height="300"]
...
.code
----
include::{sourcedir}/filters/DilationFilterTest.java[tags=dilationFilter]
----
image::DilationFilter.png[title="Dilation Filter", width="300", height="300"]
...
.code
----
include::{sourcedir}/filters/ErosionFilterTest.java[tags=erosionFilter]
----
image::ErosionFilter.png[title="Erosion Filter", width="300", height="300"]

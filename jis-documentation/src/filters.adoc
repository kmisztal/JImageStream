...
.code
----
include::{sourcedir}/filters/SobelFilter4XTest.java[tags=sobel45Filter]
----
...
.code
----
include::{sourcedir}/filters/SobelFilter4XTest.java[tags=sobel135Filter]
----
...
.code
----
include::{sourcedir}/filters/SobelFilter4XTest.java[tags=edgeDetectionSobel4XFilter]
----
--
